...
import com.uml.lexueschedule.ScheduleModule.Data.Database.MyDatabasehelper;
...
public class ScheduleFragment extends Fragment implements View.OnClickListener {
    ...
    public void afterGettingData(){
        getActivity().runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                mWeekView.source(mySubjects).showView();
                mTimetableView.source(mySubjects).updateView();
                Toast.makeText(getContext(), "调用after子线程", Toast.LENGTH_LONG).show();
            }
        });
    }
    ...
    public void insertIntoLocalDb() {
        Log.e("tag","进入test函数");
        dbhelper=new MyDatabasehelper(getContext(),"Course.db",null,1);
        SQLiteDatabase db=dbhelper.getWritableDatabase();
        db.execSQL("delete from " + "Course");
        ContentValues values=new ContentValues();
        Log.e("tag","yes0");
        for(int i = 0; i< com.uml.lexueschedule.ScheduleModule.Data.Model.Schedule.getInstance().courses.size(); i++)
        {
            Course course=
                    com.uml.lexueschedule.ScheduleModule.Data.Model.Schedule.getInstance().courses.get(i);
    ...
    public void getCoursesFromLocal() {
        ...
        if(cursor.moveToFirst()){
            com.uml.lexueschedule.ScheduleModule.Data.Model.Schedule.getInstance().courses.clear();
            do{
                ...
                Log.e("tag","课程信息");
                course.print();
                com.uml.lexueschedule.ScheduleModule.Data.Model.Schedule.getInstance().courses.add(course);
